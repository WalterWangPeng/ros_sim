...
# sleep 1
echo "now start sim"
tmux send-keys -t rossim_nav:sim.1 'source ~/ros_sim/devel/setup.bash && roslaunch ayuan_robot ayuan_robot_nav_sim_farm.launch' C-m
echo "please wait 1 seconds for next step.."
sleep 1
...
sleep 1
# nav start
tmux send-keys -t rossim_nav:nav.0 'source ~/ros_sim/devel/setup.bash && roslaunch ayuan_robot ayuan_robot_nav_farm.launch' C-m
# echo "please wait 1 seconds for next step.."
# sleep 1
